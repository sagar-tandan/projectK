...
public class Admin_SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseUser = firebaseAuth.getCurrentUser();
         ...
         databaseReference = FirebaseDatabase.getInstance().getReference("ProjectK").child("LOGIN").child("Admin");
        ...
        create_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                if ((wifi !=null && wifi.isConnected()) || (mobile != null && mobile.isConnected())){
                    ...
                    Toast.makeText(Admin_SignUp.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    private void SendUserToNextActivity() {
        Intent intent = new Intent(Admin_SignUp.this,adminPanall.class);
