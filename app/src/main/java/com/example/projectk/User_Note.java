...
public class User_Note extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((wifi !=null && wifi.isConnected()) || (mobile != null && mobile.isConnected())){
            ...
            Toast.makeText(User_Note.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    private void RetriveData() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(User_Note.this);
        ...
        reference.orderByChild("id").equalTo(codeNo).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new Note_Adapter(User_Note.this,list);
                LinearLayoutManager layoutManager = new LinearLayoutManager(User_Note.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(User_Note.this, "No such class exists", Toast.LENGTH_SHORT).show();
            }
        });
